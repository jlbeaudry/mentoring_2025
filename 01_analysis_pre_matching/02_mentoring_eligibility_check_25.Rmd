...
df_tee <- df_tee %>%
  mutate(employment_eligibility = case_when(id %in% "mentee_44" ~ "Not eligible", # PhD student
...
df_tee <- df_tee %>%
  mutate(level_eligibility = case_when(id %in% "mentee_5" ~ "Not eligible", # email from supervisor & EOI info 
...
rm (employ_a, employ_b, employ_c, level)
...
df_tee <- df_tee %>%
  mutate(conferral_eligibility = case_when(id %in% "mentee_9" ~ "Information needed", # outcome of PhD submission?
                                  id %in% "mentee_20" ~ "Information needed", # need info re: career interruptions
                                 TRUE ~ as.character("Eligible"))) %>% 
...
df_tee <- df_tee %>%
  mutate(contract_eligibility = case_when(id %in% "mentee_5" ~ "Information needed", # email
                                 id %in% "mentee_9" ~ "Information needed", # email
                                 id %in% "mentee_15" ~ "Information needed", # email
                                 id %in% "mentee_31" ~ "Information needed", # email
                                 id %in% "mentee_49" ~ "Information needed", # email
                                 id %in% "mentee_52" ~ "Information needed", # email
...
df_tee <- df_tee %>%
  mutate(eligibility = case_when(previous_mentee_eligibility == "Not eligible" ~ "Not eligible",
                               ...
                               contract_eligibility == "Not eligible" ~ "Not eligible", 
                                grepl("Information needed", employment_eligibility) ~ "Information needed", 
                                grepl("Information needed", level_eligibility) ~ "Information needed", 
                                grepl("Information needed", conferral_eligibility) ~ "Information needed", 
                               grepl("Information needed", contract_eligibility) ~ "Information needed", 
                                  TRUE ~ as.character("Eligible"))) %>% 
  mutate(eligibility = as.factor(eligibility))

# I don't know why I used GREPL??
