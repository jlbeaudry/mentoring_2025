...
# capitalise their names [but first omit folks with surnames that contain lower case letters]

# first mentors [create two tibbles, capitalise, and then join them together again]
# none in 2024, so nothing to do this year; no capitalising necessary this year either]

# df_tor1a <- df_tor %>% 
#   filter(!str_detect(surname, ("van|da"))) %>% 
...
# df_tee [df_tee == "0,6"] <- "0.6"
# df_tee [df_tee == "0.6-0.8"] <- "0.7"
