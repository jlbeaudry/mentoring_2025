...
knitr::kable(
  ...
  col.names = c("Respondent", "Role", "Response")
  ) %>%
...
The Researcher Mentoring Program for Early Career Researchers for 2025 is supporting
...
Based on the responses to the various questions, both mentors and mentees
are happy with how the program is progressing, they believe they are matched appropriately
with their partners, their meetings are going well, and the resources provided to 
them are useful. The main suggestion for improvement is to provide more informal
opportunities to connect with participants in the program. 
...
Similar numbers of mentees indicated that the program has so far exceeded their expectations. 
...
indicated that it partly met their expectations. 
No mentees indicated that it did not meet their expectations.
Of the `r expect_rate_mentee[[3]] %>% sum` 
mentees who responded to the survey, `r sum(expect$role=='Mentee')` mentees 
provided explanations of how the program aligned with their expectations
(see `r table_nums(name = "expect", display = "cite")`). 

Overall, the mentors and mentees have reported positive experiences thus far.
Most of the mentors 
reported that their mentees have been engaged and proactive, which could be 
attributed (at least in part) to the clear information and guidance provided in 
the Mentee Information session and the Program Handbook. Most of the mentees indicated
that their mentors were providing them with guidance about their future career goals. 
Some mentees indicated that they received advice about grant applications, promotion
applications, and future employment opportunities. Several mentors and mentees
said that they were well matched with their partner, despite being matched with 
partners outside of their College. 
...
which is right on track; the survey was 
...
like at this point, with `r (meetings_summary %>% filter(meetings == "Once or twice") %>% reframe(sum(n)))`
...
Taken together, the ratings were very positive. The utility of the mentoring 
agreement received the lowest ratings, which is to be expected. The agreement is 
designed as a tool to help those mentees who are less comfortable or are unsure
about how to set boundaries and expectations with their mentors; not all mentees 
and mentors will need this type of resource. Mentees and mentors rated all other 
aspects of the program very highly. 
...
asked questions that were unique to each group. We asked the mentors five unique questions. 
...
For those that were able to attend, the mentors rated the mentor-specific components
(i.e., mentor orientation session, mentor networking lunch) of the program very positively. 
Nearly all mentors believed that they were helping their mentee meet their 
...
agreed or strongly agreed to each item:
  ...
  * The first Mentee Roundtable ('Grant Writing: How to be a Narrative Ninja') was informative 
  (`r round(sum(roundtable_first_informative_agree$n)/sum(roundtable_first_informative$n)*100,0)`%).
  * The first Mentee Roundtable ('Grant Writing: How to be a Narrative Ninja') was valuable 
...
The mentees' ratings aligned with the mentors reports---they believed that the 
advice and/or guidance their mentors provided is helping with their current
aspirations and will be helpful for their future careers. The majority of respondents
indicated that the 'Grant Writing: How to be a Narrative Ninja' Mentee Roundtable
was valuable and informative; however, it wasn't rated as positively as the other
mentee-specific components of the program (i.e., mentee information session). 
Some mentees elaborated on their ratings for the 'Narrative Ninja' workshop in 
...
scale_x_discrete(
  labels = c(
    ...
    "The 'Narrative Ninja' Mentee Roundtable \nwas valuable",
    "The 'Narrative Ninja' Mentee Roundtable \nwas informative",
...
For context, this was the overview of the 'Grant Writing: How to be a Narrative Ninja' session: 

<i>This workshop will show you why narrative is so important and how to construct 
a narrative for a grant application or journal article. There will be demonstrations 
of creating a narrative and opportunity to practice creating your own narrative 
for either a part of your idea or your whole idea.
 ...
 * how to write the narrative of your own piece of work. </i>
...
In this program, the mentors and mentees meet together according to their own needs and availability, so we have little oversight
into their meetings and discussions. Thus, it's critical to ask them how it is 
progressing and to give them an opportunity to identify any issues. As such, we 
asked several open-ended questions to get a better understanding of their 
experiences in the program, thus far.
...
Overall, the mentors reported that their meetings with their mentees are going well, 
with some indicating that their meetings are more informal whereas others
reported that their meetings are more structured. The advice I provided at the outset
was that they could adopt whatever approach worked best for their partnership, so 
I am pleased to see that different pairs have taken different approaches. One mentor 
reported using the Program Handbook and other resources to shift their meetings 
from a manager-staff style meeting to a mentor-mentee approach. The mentees' responses
mimic those of the mentors; the meetings are going well, with some adopting an 
informal approach and others holding more formal meetings with agendas. 
...
Common responses to the best parts of the program were the one-on-one meetings, 
the match with their partner, the structure and support provided by the program, 
and the opportunity to meet others (both mentees and mentors) outside of their own 
Colleges. Several mentors said that they liked that they had a chance to give back 
and to support their junior colleagues. 
...
The most common response was that no changes were required because the 
program is working well. Nonetheless, some mentors suggested that mentees would
benefit from more assistance with creating clear goals to guide their discussions 
with their mentors, and that the mentors themselves would benefit from having 
tangible examples of areas that they should discuss with their mentees. One mentee
said that hybrid events would be useful for those travelling; however, with the 
exception of the Mentor Networking Lunch, all events are offered as hybrid events 
because we have two mentees in the Northern Territory. Other mentees suggested
that it would be useful to have more opportunities to connect with mentees and 
mentors outside of the formal program. 
...
Participants were asked if there was anything else that they wanted 
