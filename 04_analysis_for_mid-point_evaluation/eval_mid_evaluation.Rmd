...
are happy with how the program is progressing, they believe they were matched appropriately
with their partners, their meetings are going well, and the resources provided to 
them have been useful. The main suggestion for improvement is to provide more informal
...
For completeness, this was the overview of the 'Grant Writing: How to be a Narrative Ninja' session: 
...
In this program, the mentors and mentees meet on their own 
schedules based on their own needs and availability, so we have little oversight
...
mimic those of the mentors; the meetings are going well, with some adopted an 
...
program worked well as is. Nonetheless, some mentors suggested that mentees would
